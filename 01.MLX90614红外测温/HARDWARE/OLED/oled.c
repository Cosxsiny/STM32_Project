...
void display(void)  
{	
	OLED_ShowCHinese16x16(0,2,0,LOGO); //温
	OLED_ShowCHinese16x16(16,2,1,LOGO);//度
	OLED_ShowCHinese16x16(0,6,2,LOGO); //距
	OLED_ShowCHinese16x16(16,6,3,LOGO); //离
	OLED_ShowCHinese16x16(32,0,4,LOGO); //红
	OLED_ShowCHinese16x16(48,0,5,LOGO); //外
	OLED_ShowCHinese16x16(64,0,6,LOGO); //测
	OLED_ShowCHinese16x16(80,0,7,LOGO); //温
	OLED_ShowCHinese16x16(96,0,8,LOGO); //仪
}
